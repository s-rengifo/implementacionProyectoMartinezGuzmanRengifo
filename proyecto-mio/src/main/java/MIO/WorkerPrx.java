...
{
    default ProcessingResult processTask(ProcessingTask task, GraphInfo graphInfo)
        throws ProcessingException
    {
        return processTask(task, graphInfo, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default ProcessingResult processTask(ProcessingTask task, GraphInfo graphInfo, java.util.Map<String, String> context)
        throws ProcessingException
    {
        try
        {
            return _iceI_processTaskAsync(task, graphInfo, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<ProcessingResult> processTaskAsync(ProcessingTask task, GraphInfo graphInfo)
    {
        return _iceI_processTaskAsync(task, graphInfo, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<ProcessingResult> processTaskAsync(ProcessingTask task, GraphInfo graphInfo, java.util.Map<String, String> context)
    {
        return _iceI_processTaskAsync(task, graphInfo, context, false);
    }

    /**
     * @hidden
     * @param iceP_task -
     * @param iceP_graphInfo -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<ProcessingResult> _iceI_processTaskAsync(ProcessingTask iceP_task, GraphInfo iceP_graphInfo, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<ProcessingResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "processTask", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_processTask);
        f.invoke(true, context, null, ostr -> {
                     ProcessingTask.ice_write(ostr, iceP_task);
                     GraphInfo.ice_write(ostr, iceP_graphInfo);
                 }, istr -> {
                     ProcessingResult ret;
                     ret = ProcessingResult.ice_read(istr);
                     return ret;
                 });
        return f;
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "isAvailable", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getWorkerId", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     String ret;
                     ret = istr.readString();
                     return ret;
